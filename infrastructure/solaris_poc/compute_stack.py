...
class ComputeStack(cdk.Stack):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Functions include dependencies directly
        ...
        self.agent_workflow_lambda = self._create_agent_workflow(
            common_layer=None,
            vpc=vpc,
            security_group=security_group,
            documents_bucket=documents_bucket,
    ...
    def _create_document_processor(
        ...
        log_group = logs.LogGroup(
            ...
            log_group_name="/aws/lambda/solaris-poc-document-processor",
    ...
    def _create_agent_workflow(
        ...
        # DynamoDB permissions for sessions
        if sessions_table:
        ...
        log_group = logs.LogGroup(
            self,
            "AgentWorkflowLogs",
            log_group_name="/aws/lambda/solaris-poc-agent-workflow",
            retention=logs.RetentionDays.ONE_WEEK,
            removal_policy=cdk.RemovalPolicy.DESTROY,
        )
